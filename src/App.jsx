...
//CONSTANTS
import { getDescriprionHeader, getPathName } from "./utils/constant";
  ...
  return (
    <Layout hasSider>
      ...
      <Layout
        className="layout"
        style={
          window.innerWidth <= 768 ? { marginLeft: 0 } : { marginLeft: 200 }
        }
      >
        ...
        >
          ...
          <div
            className={`site-layout-content ${
              window.innerWidth <= 768 ? "site-layout-content-mobile" : ""
            }`}
          >
            <Router>
              <Routes>
